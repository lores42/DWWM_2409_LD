...
INSERT INTO questions
 ...
 ("5", "2024-12-05", "Que signifie le sigle noSQ?", "Not Only SQL!", "3");

INSERT INTO categories_questions
(question_id, category_name)
VALUES
("n°1", "Base de donnée et SQL"),
("n°2", "Base de donnée et SQL"),
("n°3", " Base de données"),
("n°4", " Base de données et SQL"),
("n°5", " Basse de données et NoSQL");